                ...
                return InkWell(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      border: Border.all(
                          color: textController == null
                              ? grey2.withOpacity(0.5)
                              : Colors.black,
                          width: textController == null ? 1.5 : 0.8),
                    ...
                    child: Row(
                      ...
                      children: [
                        Text(
                          textController == null
                              ? hintText
                              : textController.toString(),
                          style: TextStyle(
                            fontFamily: 'Lato',
                            fontSize: 14,
                            fontWeight: FontWeight.w400,
                            color: textController == null ? grey : Colors.black,
                          ),
                        ),
                        Icon(
              ...
              return TextFormField(
                ...
                decoration: InputDecoration(
                  ...
                  border: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(12.0),
                    borderSide:
                        BorderSide(color: grey2.withOpacity(0.5), width: 1.5),
                  ),
                ),
